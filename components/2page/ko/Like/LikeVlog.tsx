...
const LikeVlog: FC<Props> = (props: Props) => {
  ...
  function heart(i: number) {
    if (i === 0 && like0 === 0) {
      ...
      return <span className="like">{like0 === 1 ? '💛' : '🤍'}</span>;
    } else if (i === 1 && like1 === 0) {
      return (
        <span className="like">
          {dblikedlist.find((e: number) => e === props.vlogplaceid[i]) === props.vlogplaceid[i] ? '💛' : '🤍'}
      ...
      return <span className="like">{like1 === 1 ? '💛' : '🤍'}</span>;
    } else if (i === 2 && like2 === 0) {
      return (
        <span className="like">
          {dblikedlist.find((e: number) => e === props.vlogplaceid[i]) === props.vlogplaceid[i] ? '💛' : '🤍'}
      ...
      return <span className="like">{like2 === 1 ? '💛' : '🤍'}</span>;
    } else if (i === 3 && like3 === 0) {
      return (
        <span className="like">
          {dblikedlist.find((e: number) => e === props.vlogplaceid[i]) === props.vlogplaceid[i] ? '💛' : '🤍'}
      ...
      return <span className="like">{like3 === 1 ? '💛' : '🤍'}</span>;
    } else if (i === 4 && like4 === 0) {
      return (
        <span className="like">
          {dblikedlist.find((e: number) => e === props.vlogplaceid[i]) === props.vlogplaceid[i] ? '💛' : '🤍'}
      ...
      return <span className="like">{like4 === 1 ? '💛' : '🤍'}</span>;
    } else if (i === 5 && like5 === 0) {
      return (
        <span className="like">
          {dblikedlist.find((e: number) => e === props.vlogplaceid[i]) === props.vlogplaceid[i] ? '💛' : '🤍'}
      ...
      return <span className="like">{like5 === 1 ? '💛' : '🤍'}</span>;
    } else if (i === 6 && like6 === 0) {
      return (
        <span className="like">
          {dblikedlist.find((e: number) => e === props.vlogplaceid[i]) === props.vlogplaceid[i] ? '💛' : '🤍'}
      ...
      return <span className="like">{like6 === 1 ? '💛' : '🤍'}</span>;
    } else if (i === 7 && like7 === 0) {
      return (
        <span className="like">
          {dblikedlist.find((e: number) => e === props.vlogplaceid[i]) === props.vlogplaceid[i] ? '💛' : '🤍'}
      ...
      return <span className="like">{like7 === 1 ? '💛' : '🤍'}</span>;
    } else if (i === 8 && like8 === 0) {
      return (
        <span className="like">
          {dblikedlist.find((e: number) => e === props.vlogplaceid[i]) === props.vlogplaceid[i] ? '💛' : '🤍'}
      ...
      return <span className="like">{like8 === 1 ? '💛' : '🤍'}</span>;
    } else if (i === 9 && like9 === 0) {
      return (
        <span className="like">
          {dblikedlist.find((e: number) => e === props.vlogplaceid[i]) === props.vlogplaceid[i] ? '💛' : '🤍'}
      ...
      return <span className="like">{like9 === 1 ? '💛' : '🤍'}</span>;
      ...
      return <span className="like">{like10 === 1 ? '💛' : '🤍'}</span>;
      ...
      return <span className="like">{like11 === 1 ? '💛' : '🤍'}</span>;
      ...
      return <span className="like">{like12 === 1 ? '💛' : '🤍'}</span>;
      ...
      return <span className="like">{like13 === 1 ? '💛' : '🤍'}</span>;
      ...
      return <span className="like">{like14 === 1 ? '💛' : '🤍'}</span>;
      ...
      return <span className="like">{like15 === 1 ? '💛' : '🤍'}</span>;
      ...
      return <span className="like">{like16 === 1 ? '💛' : '🤍'}</span>;
      ...
      return <span className="like">{like17 === 1 ? '💛' : '🤍'}</span>;
      ...
      return <span className="like">{like18 === 1 ? '💛' : '🤍'}</span>;
      ...
      return <span className="like">{like19 === 1 ? '💛' : '🤍'}</span>;
    }
  } //heart
      ...
      <>
        <li className="icon_li custom-control">
          ...
          <label className="custom" htmlFor="listidx0">
            {heart(0)}
            <span className="likeplace" onClick={() => tokakaomap(0)}>
              {' '}
      ...
      <>
        <li className="icon_li custom-control">
          ...
          <label className="custom" htmlFor="listidx1">
            {heart(1)}
            <span className="likeplace" onClick={() => window.open(`${props.placeurl[0]}`, '_blank')}>
      ...
      <>
        <li className="icon_li custom-control">
          ...
          <label className="custom" htmlFor="listidx2">
            {heart(2)}
            <span className="likeplace" onClick={() => window.open(`${props.placeurl[2]}`, '_blank')}>
      ...
      <>
        <li className="icon_li custom-control">
          ...
          <label className="custom" htmlFor="listidx3">
            {heart(3)}
            <span className="likeplace" onClick={() => window.open(`${props.placeurl[3]}`, '_blank')}>
      ...
      <>
        <li className="icon_li custom-control">
          ...
          <label className="custom" htmlFor="listidx4">
            {heart(4)}
            <span className="likeplace" onClick={() => window.open(`${props.placeurl[4]}`, '_blank')}>
      ...
      <>
        <li className="icon_li custom-control">
          ...
          <label className="custom" htmlFor="listidx5">
            {heart(5)}
            <span className="likeplace" onClick={() => window.open(`${props.placeurl[5]}`, '_blank')}>
      ...
      <>
        <li className="icon_li custom-control">
          ...
          <label className="custom" htmlFor="listidx6">
            {heart(6)}
            <span className="likeplace" onClick={() => window.open(`${props.placeurl[6]}`, '_blank')}>
      ...
      <>
        <li className="icon_li custom-control">
          ...
          <label className="custom" htmlFor="listidx7">
            {heart(7)}
            <span className="likeplace" onClick={() => window.open(`${props.placeurl[7]}`, '_blank')}>
      ...
      <>
        <li className="icon_li custom-control">
          ...
          <label className="custom" htmlFor="listidx8">
            {heart(8)}
            <span className="likeplace" onClick={() => window.open(`${props.placeurl[8]}`, '_blank')}>
      ...
      <>
        <li className="icon_li custom-control">
          ...
          <label className="custom" htmlFor="listidx9">
            {heart(9)}
            <span className="likeplace" onClick={() => window.open(`${props.placeurl[9]}`, '_blank')}>
