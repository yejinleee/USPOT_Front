...
const Liketop5 :FC<Props> = ({children,top5name, top5placeid}) => {
  ...
  */}
  ...
  function func(e:number) {   //onCLick이벤트 여러개이려면 함수여야해서
    var ethplaceid = top5placeid[e];

    if (e===0){
      if(like0===0 || like0===2) {    //처음 onClick때 setlike 한게 func에 반영 안되서 이렇게 해야할듯
        func_post(e);
      }
      else if (like0===1){
        func_delete(e);
        ...
        <span style={{ position: 'absolute'}}>
          <ul>
            <li className = "icon_li custom-control">
                <input type="checkbox" className="cate" id="listidx0" onClick={()=> {func(0); like0===1 ? setLike0(2):setLike0(1)}} value="0" />
              {/*{func(0)}*/}
            ...
            <li className = "icon_li custom-control">
                <input type="checkbox" className="cate" id="listidx1" onClick={()=> {func(1); like1===1 ? setLike1(2):setLike1(1)}} value="1" />
              {/*{func(1)}*/}
            ...
            <li className = "icon_li custom-control">
                <input type="checkbox" className="cate" id="listidx2" onClick={()=> {func(2);like2===1 ? setLike2(2):setLike2(1)}} value="2" />
              {/*{func(2)}*/}
            ...
            <li className = "icon_li custom-control">
                <input type="checkbox" className="cate" id="listidx3" onClick={()=> {func(3);like3===1 ? setLike3(2):setLike3(1)}} value="3" />
              {/*{func(3)}*/}
            ...
            <li className = "icon_li custom-control">
                <input type="checkbox" className="cate" id="listidx4" onClick={()=> {func(4);like4===1 ? setLike4(2):setLike4(1)}} value="4" />
              {/*{func(4)}*/}
